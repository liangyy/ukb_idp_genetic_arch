...
for(top_n in c(1, 2, 5, 10, 20, 50)) {
  ...
  arrow::write_parquet(mat_out, paste0('~/Desktop/tmp/ukb_idp/regress_out_idp_pcs/2020-05-18_final-phenotypes.regress_out_', top_n, 'PCs.parquet'))
}
