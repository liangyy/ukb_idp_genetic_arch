bash submit_run_w_perm.sh \
  ...
  /gpfs/data/im-lab/nas40t2/yanyul/GitHub/ukb_idp_genetic_arch/submission/genetic_cor/fourth_round_dmri_residual.txt \
  /scratch/t.cri.yliang/ukb_idp/genetic_cor_4th_w_perm \
  10 \
