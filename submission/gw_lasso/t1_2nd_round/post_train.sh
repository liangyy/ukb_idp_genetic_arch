# args1: nametag
nametag=$1
outdir=/scratch/t.cri.yliang/ukb_idp/gw_elastic_net_t1_2nd/$nametag
phenopre=/gpfs/data/im-lab/nas40t2/yanyul/GitHub/ukb_idp_genetic_arch/submission/gw_lasso/t1_2nd_round/list_misc/$nametag/pheno_list
tmplist=batch_list_$nametag.txt
outdir2=/scratch/t.cri.yliang/ukb_idp/gw_elastic_net_t1_2nd
if [[ -f $tmplist ]]
then
  rm $tmplist
fi
