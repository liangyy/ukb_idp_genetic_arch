...
nametag="ideal_permz_1000_param2"
geno_cov="/gpfs/data/im-lab/nas40t2/yanyul/ukb_idp/simulation/bxcan_1000/group1.geno_cov.chr{chr_num}.banded.npz"

outdir="/gpfs/data/im-lab/nas40t2/yanyul/ukb_idp/simulation/ideal_bxcan_1000_permz_param2"
...
for rand in "${rand_seeds[@]}"; do
  (( kk2 = rand0 + rand + 20 ))
  idpname="param2.rand_${rand}.snp_effect"
